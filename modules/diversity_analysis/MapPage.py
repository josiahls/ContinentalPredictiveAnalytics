...
class MapPage(Page):
    def __init__(self):
        ...
        self.csv_locations = ['parsed_location.csv']
        ...
        self.date_range = [date for date in self.master_csv['local']['Hire.Date']]
        del self.date_range[0]
        ...
        return html.Div([
            html.Div([
                html.Div([
                    html.H3('Categories'),
                    dcc.Dropdown(
                        id='category_diversity_dropdown',
